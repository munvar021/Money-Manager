        ...
        <div className="content-container">
          <div className="user-greeting-container">
            ...
            <p className="greeting-info">
              ...
              <span className="greeting-info-span"> Money Manager</span>
            </p>
          </div>
          <MoneyDetails
          ...
          />
          <div className="transaction-input-details">
            <form className="transaction-form" onSubmit={this.onAddTransaction}>
              <h1 className="transaction-heading">Add Transaction</h1>
              <label className="label" htmlFor="expenseTitle">
                TITLE
              </label>
              <input
                type="text"
              ...
              <input
                ...
                placeholder="AMOUNT"
              />
              <label className="label" htmlFor="expenseType">
                TYPE
              </label>
              <select
                id="expenseType"
